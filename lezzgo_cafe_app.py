...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .eyebrow{
    ...
    letter-spacing:1px; margin-bottom:14px; border:1px solid var(--line);
    border-radius:4px; padding:5px 10px; background:rgba(255,111,165,.07);
  }
  ...
  h1{
    ...
    font-size:clamp(44px,13vw,68px); line-height:.96; letter-spacing:1px;
    text-shadow:0 3px 0 var(--pink-deep),3px 3px 0 var(--pink-deep),4px 6px 0 var(--black);
  }
  .intro{
    margin:22px auto 4px; max-width:300px; font-family:'Galmuri11',monospace;
    font-size:14px; line-height:1.75; color:#efe7da;
  }
