...
st.markdown(
    ...
    <style>
      ...
      div.stButton > button{
        width:100%; max-width:380px; display:block; margin:0 auto 14px;
      ...
      .q-title{ text-align:center; color:var(--ink); font-family:'Galmuri11','DungGeunMo',monospace;
        font-size:clamp(22px,5.8vw,28px); line-height:1.55; margin:0 auto 40px; max-width:430px;
